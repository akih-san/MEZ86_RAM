...
uint8_t ctlq_ev;
uint8_t	irq_sig;	// irq request flag
...
static char *ttbasic = "TT_BAS86.BIN";
static char *vtl = "VTL_S86.BIN";
static char *game = "GMI_S86.BIN";
static char *unimon_s = "UMON_S86.BIN";
...
static char *board_name = "MEZ86_RAM Firmware Rev1.3";
...
void main(void)
{
	...
	intr_req = 0;
	irq_flg = 0;
	irq_sig = 0;	// clear irq request flag
