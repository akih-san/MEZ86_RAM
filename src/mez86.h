...
#define MAX_MEM_SIZE	0x00100000			// 1MB
#define bioreq_ubuffadr	0xff500				// unimon request IO header address
#define bioreq_cbuffadr	0xff506				// cpm cbios request IO header address
#define bioreq_buffadr	0xff500				// dos bios(unimon request IO header address)
...
extern uint16_t irq_flg;				// irq flag (0:not use irq, 1:use irq)
extern uint8_t irq_sig;				// irq request flag
...
extern void enable_clc4int(void);
extern void disable_clc4int(void);
extern void reset_clc4(void);
